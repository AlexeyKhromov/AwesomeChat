...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database = FirebaseDatabase.getInstance("https://chatapp-9d8a7-default-rtdb.europe-west1.firebasedatabase.app");
    ...
    private void loginSignUpUser(String email, String password) {
        if (loginModeActive) {
            if (passwordEditText.getText().toString().trim().length() < 7) {
                Toast.makeText(this, "Password must be at least 7 character", Toast.LENGTH_SHORT).show();
